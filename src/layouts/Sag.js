    ...
    return (
        <div>
            <Routes>
                ...
                <Route exact path="/myPage/:id/MyInternshipRequestAdd" element={<AddInternshipRequest />} />
                <Route exact path="/myPage/:id/AddCompany" element={<AddCompany />} />
                <Route exact path="/myPage/:id/Companies" element={<Companies />} />
                <Route exact path="/myPage/:id/Profil" element={<Profil />} />


                <Route exact path="/adminPage/:id/Companies" element={<Companies />} />
                <Route exact path="/adminPage/:id/Profil" element={<Profil />} />
                <Route exact path="/adminPage/:id/AddCompany" element={<AddCompany />} />
                ...
                <Route exact path="/secretaryPage/:id/Profil" element={<Profil />} />
